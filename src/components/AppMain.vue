...
export default {
  ...
  methods: {
    ...
    converterAverage(average) {
      ...
      const result = Math.ceil(operazione)
      return result
    },
  }
}
    ...
    <div class="container">
      ...
      <div class="row row-cols-2 row-cols-sm-4 row-cols-md-6 row-cols-lg-9 g-1">
        <div v-for="film in store.movieArr" class="col">
          <div>
            <img class="img-fluid" :src="getImgPoster(film.poster_path)" alt="">
          </div>
      ...
      <div class="row row-cols-2 row-cols-sm-4 row-cols-md-6 row-cols-lg-9">
        <div v-for="serieTv in store.seriesTvArr" class="col">
          <div>
            <img class="img-fluid" :src="getImgPoster(serieTv.poster_path)" alt="">
          </div>
